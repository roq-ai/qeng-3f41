  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to QENG - Your comprehensive solution for building engineering systems. Streamlining project management and membership systems for optimal selection of superintending engineers."
        />
      </Head>
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1581094373271-1fa59e2ab263?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxidWlsZGluZyUyMGVuZ2luZWVyaW5nfGVufDB8fHx8MTY5MTgxODE2MXww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to QENG - Your comprehensive solution for building engineering systems. Streamlining project management and membership systems for optimal selection of superintending engineers.`}
            </Text>
            <Box
